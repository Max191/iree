...
func.func @fold_extract_slice_of_padding_hint() -> tensor<16x32xf16> {
  ...
  %hint = iree_codegen.bank_conflict_padding_hint %empty[padding_bits = 64] : tensor<64x64xf16>
...
//       CHECK:   %[[HINT:.+]] = iree_codegen.bank_conflict_padding_hint %[[EMPTY]][padding_bits = 64] : tensor<16x32xf16>
//       CHECK:   return %[[HINT]]
...
func.func @fold_expand_shape_of_padding_hint() -> tensor<4x16x64xf16> {
  %empty = tensor.empty() : tensor<64x64xf16>
  %hint = iree_codegen.bank_conflict_padding_hint %empty[padding_bits = 32] : tensor<64x64xf16>
...
//       CHECK:   %[[HINT:.+]] = iree_codegen.bank_conflict_padding_hint %[[EMPTY]][padding_bits = 32] : tensor<4x16x64xf16>
//       CHECK:   return %[[HINT]]
...
func.func @fold_collapse_shape_of_padding_hint() -> tensor<64x64xf16> {
  ...
  %hint = iree_codegen.bank_conflict_padding_hint %empty[padding_bits = 64] : tensor<4x16x4x16xf16>
...
//       CHECK:   %[[HINT:.+]] = iree_codegen.bank_conflict_padding_hint %[[EMPTY]][padding_bits = 64] : tensor<64x64xf16>
//       CHECK:   return %[[HINT]]
...
func.func @no_fold_extract_slice_non_empty_padding(%arg0: tensor<64x64xf16>) -> tensor<16x32xf16> {
  %hint = iree_codegen.bank_conflict_padding_hint %arg0[padding_bits = 64] : tensor<64x64xf16>
  %slice = tensor.extract_slice %hint[0, 0] [16, 32] [1, 1] : tensor<64x64xf16> to tensor<16x32xf16>
  return %slice : tensor<16x32xf16>
}
...
//       CHECK:   %[[HINT:.+]] = iree_codegen.bank_conflict_padding_hint %[[ARG0]][padding_bits = 64] : tensor<64x64xf16>
