...
// RUN: iree-opt %s --split-input-file --pass-pipeline="builtin.module(func.func(iree-codegen-gpu-reduce-bank-conflicts))" | FileCheck %s --check-prefix=HINT
...
// HINT-LABEL: func.func @pad_alloc
// HINT:         memref.alloc() : memref<4x32x64xf32, #gpu.address_space<workgroup>>
...
// HINT-LABEL: func.func @pad_alloc_expand_shape
// HINT:         memref.alloc() : memref<4x32x64xf32, #gpu.address_space<workgroup>>
// HINT-NOT:     memref.subview
...
// HINT-LABEL: func.func @no_pad_alloc_collapse_shape
...
// HINT-LABEL: func.func @no_pad_alloc_collapse_shape_throughsubview
...
// HINT-LABEL: func.func @pad_alloc_collapse_outer_shape
...
// HINT-LABEL: func.func @pad_alloc_negative
...
// HINT-LABEL: func.func @pad_alloc_rank_zero
...
// CHECK-NOT:     memref.subview
// HINT-LABEL: func.func @no_padding_when_close_to_limit
...
// CHECK-NOT:     memref.subview
// HINT-LABEL: func.func @no_padding_if_at_limit
...
// HINT-LABEL: func.func @pad_if_below_limit
// HINT:         memref.alloc() : memref<4x32x126xf32, #gpu.address_space<workgroup>>
// HINT-NOT:     memref.subview
...
// With padding-bits=0 (HINT prefix), only hinted allocs get padded.
// With padding-bits=64 (CHECK prefix), hints override the fallback.
//
...
// HINT-LABEL: func.func @pad_with_hint_32bit
// HINT:         memref.alloc() : memref<4x32x65xf32, #gpu.address_space<workgroup>>
// HINT-NOT:     iree_gpu.bank_conflict_padding_hint
...
// CHECK-NOT:     iree_gpu.bank_conflict_padding_hint
// HINT-LABEL: func.func @pad_with_hint_128bit
// HINT:         memref.alloc() : memref<4x32x68xf32, #gpu.address_space<workgroup>>
// HINT-NOT:     iree_gpu.bank_conflict_padding_hint
...
// Mixed: hinted alloc gets hint padding, unhinted alloc gets fallback or none.
...
// CHECK-NOT:     iree_gpu.bank_conflict_padding_hint
// HINT-LABEL: func.func @mixed_hinted_and_unhinted
// HINT-DAG:     memref.alloc() : memref<2x16x65xf32, #gpu.address_space<workgroup>>
// HINT-DAG:     memref.alloc() : memref<2x16x64xf32, #gpu.address_space<workgroup>>
// HINT-NOT:     iree_gpu.bank_conflict_padding_hint
...
// CHECK-NOT:     memref.subview
// CHECK-NOT:     iree_gpu.bank_conflict_padding_hint
// HINT-LABEL: func.func @hint_zero_padding
...
// CHECK-NOT:     memref.subview
// CHECK-NOT:     iree_gpu.bank_conflict_padding_hint
// HINT-LABEL: func.func @conflicting_hints_no_padding
...
// CHECK:         memref.alloc() : memref<4x2x16x8x8xf32, #gpu.address_space<workgroup>>
// CHECK-NOT:     memref.subview
// HINT-LABEL: func.func @no_pad_collapse_shape_with_hint
