...
struct GPUReduceBankConflictsPass final
  ...
  void runOnOperation() override {
    ...
    // Padding is driven by BankConflictPaddingHintOp hints placed during
    // promotion. Allocs without hints fall back to the paddingBits option
    // (0 by default, meaning no fallback padding).
    DenseMap<memref::AllocOp, unsigned> hintMap =
