...
int64_t getIntrinsicSubgroupSize(ScaledMMAIntrinsic intrinsic) { return 64; }
...
void DataTiledMMAAttr::getDataTiledElementTypes(
...
static int64_t getScaledIntrinsicSubgroupSize(ScaledMMAIntrinsic intrinsic) {
  switch (intrinsic) {
  case ScaledMMAIntrinsic::MFMA_SCALE_F32_16x16x128_B32:
  case ScaledMMAIntrinsic::MFMA_SCALE_F32_32x32x64_B32:
    return 64;
...
int64_t ScaledMMAAttr::getSubgroupSize() const {
  return getScaledIntrinsicSubgroupSize(getIntrinsic());
}
...
IREE::Codegen::TileMxNxK DataTiledScaledMMAAttr::getTileMNK() const {
  IREE::Codegen::TileMxNxK innerTile;
...
void DataTiledScaledMMAAttr::getDataTiledElementTypes(
    SmallVectorImpl<Type> &result) const {
