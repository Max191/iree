...
//          CHECK:     scf.for
//      CHECK-DAG:       vector.transfer_read {{.*}}memref<2x35x35x1281xf16,{{.*}}#amdgpu.address_space<fat_raw_buffer>>{{.*}}vector<1xf16>
//      CHECK-DAG:       vector.transfer_write {{.*}}memref<1x32x36xf16, #gpu.address_space<workgroup>>
//          CHECK:       gpu.barrier
