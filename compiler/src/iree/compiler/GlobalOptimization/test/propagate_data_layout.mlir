// RUN: iree-opt --pass-pipeline="builtin.module(iree-global-opt-fold-global-unit-dims,iree-global-opt-propagate-data-layout,cse)" --split-input-file %s | FileCheck %s
...
module @pack_propagation {
  ...
  util.global private mutable @_global_state.global {noinline} = #util.uninitialized : tensor<1x1x4095x32x128xf32>
  util.func @pack_across_globals(%arg0: tensor<32x1x64x1x2xf32>, %arg1: tensor<32x128xf32>) -> tensor<32x1x?x1x16xf32> {
    ...
    %_global_state.global = util.global.load @_global_state.global : tensor<1x1x4095x32x128xf32>
    ...
    %inserted_slice = tensor.insert_slice %arg1 into %_global_state.global[0, 0, %_global_seq_step.global, 0, 0] [1, 1, 1, 32, 128] [1, 1, 1, 1, 1] : tensor<32x128xf32> into tensor<1x1x4095x32x128xf32>
    %extracted_slice = tensor.extract_slice %inserted_slice[0, 0, 0, 0, 0] [1, 1, %0, 32, 128] [1, 1, 1, 1, 1] : tensor<1x1x4095x32x128xf32> to tensor<?x32x128xf32>
    ...
    util.global.store %inserted_slice, @_global_state.global : tensor<1x1x4095x32x128xf32>
...
//       CHECK:   private mutable @[[PACKED_GLOBAL:.+]] : tensor<32x256x64x16x2xf32>
...
//       CHECK:     %[[SEQ_STEP_DIV16:.+]] = affine.apply #[[MAP]]()[%[[SEQ_STEP]]]
//       CHECK:     %[[SEQ_STEP_MOD16:.+]] = affine.apply #[[MAP1]]()[%[[SEQ_STEP]]]
