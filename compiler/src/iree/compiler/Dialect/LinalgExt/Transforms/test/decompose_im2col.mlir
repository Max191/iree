...
// With single-element output (1x1x1x1), the fast path emits a bare
...
//       CHECK:     scf.for
//       CHECK:       scf.for
//       CHECK:         affine.delinearize_index {{.*}} into (4, 3, 3)
//       CHECK:         tensor.extract_slice %[[ARG0]]
//       CHECK:         linalg.copy
//       CHECK:         tensor.insert_slice
//   CHECK-NOT:   iree_linalg_ext.im2col
...
// Test 16: Multi-dim M+K decomposition where M inner size [16,16] > output tile [2]
// and K inner size [5,5,128] > output tile [4]. These are now decomposed as scalar
// fallback since canDecompose was removed.
...
// Scalar fallback: loops over M and K with linalg.copy.
...
// Now decomposed as scalar fallback.
